...
data-aos-duration="500" class="container bg-my mt-1 p-3" id="product">
  <div class="row">
          <div
    data-aos="flip-left" data-aos-duration="400" class="col-md-12 p-3 mb-3">
  ...
  <div class="row no-gutters">
    <div class="col-md-6">
        ...
        @foreach($single as $row)
            <div>
                <img data-u="image" src="{{ asset('uploads/'.$row->image) }}" />
                <img data-u="thumb" src="{{ asset('uploads/'.$row->image) }}" />
            </div>
        @endforeach
...
@foreach($single as $row)
    <div class="col-md-6">
      <div class="card-body">
        ...
        <p class="card-text"><small class="text-muted">Last updated {{$row->updated_at}}</small></p>
        <h4>{{ $row->price }} TK</h4>
