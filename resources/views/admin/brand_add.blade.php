...
<div class="content-header">
        ...
        <div class="leftside-content-header">
            <ul class="breadcrumbs">
                ...
                <li><i class="fa fa-home" aria-hidden="true"></i><a href="javascript:avoid(0)">Add Brand</a></li>
            </ul>
        </div>
    </div>
    <!-- =-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-= -->
        	...
        	<div class="col-sm-12 col-md-8 col-md-offset-2">
	            ...
	            <div class="panel b-primary bt-md">
	                <div class="panel-content">
	                    ...
	                    <div class="row">
	                        <div class="col-md-12">
	                            <form class="form-horizontal" method="POST" action="{{route('save-brand')}}" enctype="multipart/form-data">
	                            	@csrf
	                                ...
	                                <div class="form-group">
	                                    <label for="brand_name" class="col-sm-3 control-label">Brand Image</label>
	                                    <div class="col-sm-9">
