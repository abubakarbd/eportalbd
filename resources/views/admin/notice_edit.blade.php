        	...
        	<div class="col-sm-12 col-md-8 col-md-offset-2">
	            ...
	            <div class="panel b-primary bt-md">
	                <div class="panel-content">
	                    ...
	                    <div class="row">
	                        <div class="col-md-12">
	                            <form class="form-horizontal" method="POST" action="{{route('update-notice')}}">
	                            	@csrf
	                                <div class="form-group">
	                                    <label for="title" class="col-sm-3 control-label">Title</label>
	                                    <div class="col-sm-9">
	                                    	<input type="hidden" name="id" value="{{ $notice['id'] }}">
	                                        <input type="text" name="title" class="form-control" id="title" placeholder="Brand Name" value="{{$notice->title}}">
	                                        @error('title')
	                                	...
	                                	<div class="form-group">
                                            ...
                                            <div class="col-sm-9">
                                            <textarea name="notice" class="form-control" rows="3" id="textareaMaxLength" placeholder="Write a Notice" maxlength="5000">
                                            	{{$notice->notice}}
                                            </textarea>
